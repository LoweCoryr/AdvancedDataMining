...
write(keywords_basket,file="keywords_basket") #write out as a text file
...
movie_num$movie_length_per <-factor(movie_num$quantile,levels=c(1,2,3,4,5), labels=c("Bottom Quantile","Second Quantile","Third Quantile","Fourth Quantile","Highest Quantile"))
```
...
The function is written by [Karolis Koncevicius](http://stackoverflow.com/questions/24282143/pca-multiplot-in-r).  
